...
import { get_assistance_url } from '../../commons/environment';
...
import { getNeedAssistanceAction } from './Action';

const NeedAssistance = ({
    getNeedAssistance,
    navigation,
    needAssistancePayload,
    errMessage
}) => {
    ...
    useEffect(() => {
        let data = {
            url: get_assistance_url
        }
        getNeedAssistance(data)
    }, [])
...
const mapDispatchToProps = dispatch => {
    return {
        getNeedAssistance: data => dispatch(getNeedAssistanceAction(data)),
    };
};

const mapStateToProps = state => {
    return {
        needAssistancePayload: state.getNeedAssistanceReducer.needAssistancePayload,
        errMessage: state.getNeedAssistanceReducer.errMessage,
    };
};
