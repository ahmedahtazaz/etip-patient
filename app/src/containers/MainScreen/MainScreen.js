    ...
    return (
        <View style={styles.container}>
            <View style={styles.nameContainer} >
                <View style={styles.parentNameContainer}>
                    <View style={styles.nameTextContainer}>
                        <Text style={{ fontSize: 25, fontWeight: 'bold', marginStart: 8 }}>Hi Jenny</Text>
                        <Text style={{ textColor: 'grey', marginStart: 8 }}>Hope u r feeling healthy today</Text>
            ...
            <View style={styles.actionCertificateContainer} >
                <Text style={{ marginBottom: 8, marginStart: 8 }}>ACTIVE CERTIFICATES</Text>
                <FlatList
                    horizontal
                    data={DATA}
